...
public:
  ...
  virtual void create_session(size_t worker_id, const std::string &token) override;
  virtual bool is_valid_session(size_t worker_id, const std::string &token) override;
